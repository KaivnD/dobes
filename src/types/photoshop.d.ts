declare namespace Photoshop {
   ...
   */
  enum GallerySecurityTextColorType {
    /**
     * Black text.
     */
    BLACK = 1,
   ...
   */
  enum GallerySecurityTextPositionType {
    /**
   ...
   */
  enum GallerySecurityTextRotateType {
    /**
  ...
  class Documents {
     ...
     * @param name
     */
    getByName(name: string): AdobeDocument
  }
   ...
   * DEPRECATED.
   */
  class PhotoCDOpenOptions extends OpenOptions {
    /**
   ...
   */
  class RawFormatOpenOptions extends OpenOptions {
    /**
   ...
   */
  class GenericPDFOpenOptions extends OpenOptions {
    /**
   ...
   */
  class GenericEPSOpenOptions extends OpenOptions {
    /**
     * If true, anti-aliasing is used.
     */
    antiAlias: boolean
   ...
   */
  class DICOMOpenOptions extends OpenOptions {
    /**
   ...
   */
  class CameraRAWOpenOptions extends OpenOptions {
    /**
     * The number of bits per channel.
     */
    bitsPerChannel: BitsPerChannelType
   ...
   */
  class ExportOptionsIllustrator extends ExportOptions {
    /**
     * The path to export.
     */
   ...
   */
  class ExportOptionsSaveForWeb extends ExportOptions {
    /**
   ...
   */
  class BitmapConversionOptions extends DocumentConversionOptions {
    /**
   ...
   */
  class IndexedConversionOptions extends DocumentConversionOptions {
    /**
  ...
  class Application {
     ...
     */
    open(document: File, as?: any, asSmartObject?: boolean): AdobeDocument
  ...
  export class AdobeDocument {
     ...
     */
    duplicate(name?: string, mergeLayersOnly?: boolean): AdobeDocument
     ...
     */
    duplicate(relativeObject: object, insertionLocation: ElementPlacement): AdobeDocument
  ...
  class Channel {
     ...
     */
    duplicate(targetDocument?: AdobeDocument): Channel
